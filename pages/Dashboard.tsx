...
<IonModal isOpen={showModal && editingPost !== null}>
  ...
  <IonContent>
    <IonList>
      ...
      {imageFile && ( // Ensure imageFile is not null or undefined before rendering
        <IonItem>
          <img src={`http://127.0.0.1:8000/${imageFile}`} alt="Post Image" style={{ width: '100%', maxWidth: '200px' }} />
        </IonItem>
      )}
    </IonList>
